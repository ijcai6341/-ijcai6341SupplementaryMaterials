...
%%%%%%%%%%%%%%%%%%%%This is the model of CFBLS-pyramid%%%%%%
...
N2=6;% number of layer of feature nodes
N33=8000;% number of enhancement nodes
epochs=3;% number of epochs 
train_err=zeros(1,epochs);test_err=zeros(1,epochs);
train_time=zeros(1,epochs);test_time=zeros(1,epochs);
N1=N11; N3=N33;  
for j=1:epochs    
    [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = CFBLS_pyramid_train(train_x,train_y,test_x,test_y,s,C,N1,N3,N2);       
