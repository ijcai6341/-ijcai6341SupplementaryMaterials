...
%%%%%%%%%%%%%%%%%%%%This is the model of CFBLS-dense%%%%%%
...
N2=21;% number of layer of feature nodes
...
N1=N11; N3=N33;  
for j=1:epochs    
    [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = CFBLS_dense_train(train_x,train_y,test_x,test_y,s,C,N1,N2,N3);       
