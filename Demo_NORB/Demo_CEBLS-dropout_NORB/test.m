...
%%%%%%%%%%%%%%%%%%%%This is the model of CEBLS-dropout%%%%%%
...
N33=800;% number of enhancement nodes
N44 =10;
...
N1=N11; N3=N33;  
for j=1:epochs    
    [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = CEBLS_dropout_train(train_x,train_y,test_x,test_y,s,C,N1,N2,N3,N44);       
