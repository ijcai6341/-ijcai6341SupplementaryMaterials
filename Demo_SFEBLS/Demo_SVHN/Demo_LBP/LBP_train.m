...
for i=1:size(train_x,1)
    ...
    y1=cat(1,y1,extractLBPFeatures(reshape(train_x(i,1025:2048),32,32)/255,'CellSize',[4 4],'Normalization','None')');
...
for i=1:size(test_x,1)
    ...
    y1=cat(1,y1,extractLBPFeatures(reshape(test_x(i,1025:2048),32,32)/255,'CellSize',[4 4],'Normalization','None')');
