function [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = CEBLS_dense_train(train_x,train_y,test_x,test_y,s,C,N1,N2,N3,N4)
...
for i=1:N4
    ...
    T2 = tansig(T2 * l2);
    if rem(i,2)==0
        T21(:,N3*(int32(i/2)-1)+1:N3*int32(i/2))=T2;
        H2=[H21,T2];
        H21=H2;
    else
        H2=T2;
...
for i=1:N4
    ...
    %TT2 = sigmoid(TH2 * l2);
    if rem(i,2)==0
        TT21(:,N3*(int32(i/2)-1)+1:N3*int32(i/2))=TT2;
        HH2=[HH21,TT2];
        HH21=HH2;
    else
        HH2=TT2;
